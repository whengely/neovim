...
local servers = {
    "bashls", "sumneko_lua", "cssls", "html", "emmet_ls", "jsonls", "yamlls",
    "dockerls", "sumneko_lua", "tsserver", "gopls"
}
...
vim.api.nvim_set_keymap("n", "<space>lp",
                        "<cmd>lua vim.diagnostic.goto_prev()<CR>", opts)
vim.api.nvim_set_keymap("n", "<space>ln",
...
local on_attach = function(client, bufnr)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, "n", "gi",
                                ...
                                opts)
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<S-k>",
    ...
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<space>D",
                                ...
                                opts)
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<space>lr",
                                "<cmd>lua vim.lsp.buf.rename()<CR>", opts)
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<space>lc",
    ...
    if client.supports_method("textDocument/formatting") then
        utils.buf_command(bufnr, "LspFormatting",
