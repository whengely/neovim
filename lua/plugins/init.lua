...
return packer.startup(function(use)
    ...
    use({
        ...
        requires = {
            "neovim/nvim-lspconfig", "jose-elias-alvarez/typescript.nvim"
        }
    })
    use({
    ...
    use({
        ...
        requires = {
            ...
            "hrsh7th/cmp-nvim-lsp-document-symbol", "hrsh7th/cmp-vsnip",
    ...
    use({"TimUntersberger/neogit", config = require("plugins.configs.neogit")})
